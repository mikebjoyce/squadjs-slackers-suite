...
- `static version = '2.3.2'` — public API with dual-array queue, timeout-switch feature, token bucket system, seed bonus tokens, scramble remediation, and enhanced stats.
